...
click(p_target_left[0])
enter()
click(p_target_left[1])
enter()

drag(p_drag_down, p_drag_middle)
drag(p_drag_down, p_drag_middle)

click(p_target_left[2])
enter()
click(p_target_left[3])
enter()
click(p_target_left[4])
enter()
click(p_target_left[5])
enter()

drag(p_drag_right, p_drag_middle)
print "stop here"
time.sleep(10)
